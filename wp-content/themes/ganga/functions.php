...
define('GANGA_THEME_URL','https://wpkoi.com/ganga-wpkoi-wordpress-theme/');
define('GANGA_WPKOI_AUTHOR_URL','https://wpkoi.com/');
define('GANGA_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/');
define('GANGA_WORDPRESS_REVIEW','https://wordpress.org/support/theme/ganga/reviews/?filter=5');
define('GANGA_DOCUMENTATION','https://wpkoi.com/docs/');